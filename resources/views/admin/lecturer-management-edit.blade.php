  ...
  <div class="container">
    ...
    <main class="main-content">
        <section class="main-content container py-4">
            ...
            <form action="{{ route('admin.lecturer-management.update', $lecturer->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-edit-wrapper d-flex flex-wrap gap-4">
                    ...
                    <div class="profile-picture-container text-center">
                        <label for="profile-picture" class="picture-wrapper d-block mx-auto position-relative profile-clickable">
                            <img src="{{ asset('storage/' . $lecturer->photo) }}" alt="Profile Picture" class="profile-img rounded-circle border border-primary w-100 h-100 object-fit-cover">
