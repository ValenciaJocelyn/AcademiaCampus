...
<body>
  <div class="container">
    ...
    <main class="main-content">
      <header class="header">
        <form method="GET" action="{{ route('admin.student-management') }}" class="search-container">
            <i class="fas fa-search search-icon"></i>
            <input type="text" name="search" placeholder="Search Student" class="search-box" value="{{ request('search') }}" />
        </form>
